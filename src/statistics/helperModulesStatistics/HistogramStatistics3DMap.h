...
#ifndef ETHERNET_CLASSES_COLLECTION_HISTOGRAMSTATISTICS3DMAP_H_
#define ETHERNET_CLASSES_COLLECTION_HISTOGRAMSTATISTICS3DMAP_H_
...
#endif /* ETHERNET_CLASSES_COLLECTION_HISTOGRAMSTATISTICS3DMAP_H_ */
