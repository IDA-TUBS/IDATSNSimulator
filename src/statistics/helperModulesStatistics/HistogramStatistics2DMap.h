...
#ifndef ETHERNET_CLASSES_COLLECTION_COLLECTIONS_HISTOGRAMSTATISTICS2DMAP_H_
#define ETHERNET_CLASSES_COLLECTION_COLLECTIONS_HISTOGRAMSTATISTICS2DMAP_H_
...
#endif /* ETHERNET_CLASSES_COLLECTION_COLLECTIONS_HISTOGRAMSTATISTICS2DMAP_H_ */
