...
#ifndef ETHERNET_COLLECTION_SAMPLELATENCYSTATISTICS_H_
#define ETHERNET_COLLECTION_SAMPLELATENCYSTATISTICS_H_
...
#endif /* ETHERNET_COLLECTION_SAMPLELATENCYSTATISTICS_H_ */
