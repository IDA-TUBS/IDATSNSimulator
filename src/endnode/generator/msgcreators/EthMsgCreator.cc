...
inline int64_t EthMsgCreator::getNextUniqueFrameId()
{
...
void EthMsgCreator::handleMessage(cMessage *msg)
{
    ...
    // Load the priority from the EthMsgCreator parent module
